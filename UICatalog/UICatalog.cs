...
namespace UICatalog
{
    ...
    public class UICatalogApp
    {
        ...
        /// <summary>
        /// This shows the selection UI. Each time it is run, 
        /// it calls Application.Init to reset everything.
        /// </summary>
        /// <returns></returns>
        private static Scenario GetScenarioToRun()
        {
            ...
            _leftPane.Add( _categoryListView ); // 왼쪽패널에 카테고리 리스트뷰 추가
            ...
            _rightPane.Add( _scenarioListView ); // 오른쪽패널에 시나리오 리스트뷰 추가
        ...
        /// <summary>
        /// "ColorScheme" 메뉴바 아이템의 서브 메뉴아이템 생성
        /// </summary>
        /// <returns></returns>
        ...
        private static void _scenarioListView_OpenSelectedItem( EventArgs e )
        {
            if ( _runningScenario is null )
            {
                ...
                Application.RequestStop(); // Application.Run()의 실행을 종료( 리턴 )시킨다.
            }
        }
